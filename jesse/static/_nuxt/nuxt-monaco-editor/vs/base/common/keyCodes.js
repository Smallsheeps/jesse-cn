...
(function () {
    ...
    const mappings = [
        ...
        [1, 6 /* ScanCode.Resume */, '继续', 0 /* KeyCode.Unknown */, empty, 0, empty, empty, empty],
        ...
        [1, 82 /* ScanCode.Delete */, '删除', 20 /* KeyCode.Delete */, '删除', 46, 'VK_DELETE', empty, empty],
        ...
        [1, 123 /* ScanCode.Help */, '帮助', 0 /* KeyCode.Unknown */, empty, 0, empty, empty, empty],
        [1, 124 /* ScanCode.Select */, '选择', 0 /* KeyCode.Unknown */, empty, 0, empty, empty, empty],
        ...
        [1, 128 /* ScanCode.Copy */, '复制', 0 /* KeyCode.Unknown */, empty, 0, empty, empty, empty],
